...
const myFavSuperheroes=["IronMan","Spiderman","Hulk","Thor","Hawkeye"];
...
myFavSuperheroes.splice(3,1,"F2")
console.log(myFavSuperheroes);
...
const superheroUniverse=[
    ["IronMan","Spiderman","Hulk","Thor","Hawkeye"],
    ["BatMan","SuperMan","GreenLantern","Flash","Aquaman"]
]
